...
const COMMANDS = ['orca-ask', 'orca-tell', 'orca-read', 'orca-show', 'orca-spawn', 'orca-recover'];
...
orca-tell, orca-read, orca-show, orca-spawn and orca-recover into <project>/.claude/bin/:
